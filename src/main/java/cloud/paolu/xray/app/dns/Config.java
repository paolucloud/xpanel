...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cloud.paolu.xray.app.dns.Config.class, cloud.paolu.xray.app.dns.Config.Builder.class);
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_HostMapping_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_HostMapping_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              cloud.paolu.xray.app.dns.Config.HostMapping.class, cloud.paolu.xray.app.dns.Config.HostMapping.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof cloud.paolu.xray.app.dns.Config.HostMapping)) {
        return super.equals(obj);
      }
      cloud.paolu.xray.app.dns.Config.HostMapping other = (cloud.paolu.xray.app.dns.Config.HostMapping) obj;
    ...
    public static cloud.paolu.xray.app.dns.Config.HostMapping parseFrom(
    ...
    public static cloud.paolu.xray.app.dns.Config.HostMapping parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static cloud.paolu.xray.app.dns.Config.HostMapping parseFrom(
    ...
    public static cloud.paolu.xray.app.dns.Config.HostMapping parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static cloud.paolu.xray.app.dns.Config.HostMapping parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static cloud.paolu.xray.app.dns.Config.HostMapping parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(cloud.paolu.xray.app.dns.Config.HostMapping prototype) {
    ...
    public static final class Builder extends
        ...
        cloud.paolu.xray.app.dns.Config.HostMappingOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_HostMapping_descriptor;
      }
      ...
      // Construct using cloud.paolu.xray.app.dns.Config.HostMapping.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public cloud.paolu.xray.app.dns.Config.HostMapping getDefaultInstanceForType() {
        return cloud.paolu.xray.app.dns.Config.HostMapping.getDefaultInstance();
      }

      @java.lang.Override
      public cloud.paolu.xray.app.dns.Config.HostMapping build() {
        cloud.paolu.xray.app.dns.Config.HostMapping result = buildPartial();
      ...
      @java.lang.Override
      public cloud.paolu.xray.app.dns.Config.HostMapping buildPartial() {
        cloud.paolu.xray.app.dns.Config.HostMapping result = new cloud.paolu.xray.app.dns.Config.HostMapping(this);
      ...
      private void buildPartialRepeatedFields(cloud.paolu.xray.app.dns.Config.HostMapping result) {
      ...
      private void buildPartial0(cloud.paolu.xray.app.dns.Config.HostMapping result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof cloud.paolu.xray.app.dns.Config.HostMapping) {
          return mergeFrom((cloud.paolu.xray.app.dns.Config.HostMapping)other);
        } else {
      ...
      public Builder mergeFrom(cloud.paolu.xray.app.dns.Config.HostMapping other) {
        if (other == cloud.paolu.xray.app.dns.Config.HostMapping.getDefaultInstance()) return this;
        if (other.type_ != 0) {
    ...
    private static final cloud.paolu.xray.app.dns.Config.HostMapping DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new cloud.paolu.xray.app.dns.Config.HostMapping();
    }

    public static cloud.paolu.xray.app.dns.Config.HostMapping getDefaultInstance() {
  ...
  @SuppressWarnings("serial")
  private java.util.List<cloud.paolu.xray.common.net.Endpoint> nameServers_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public java.util.List<cloud.paolu.xray.common.net.Endpoint> getNameServersList() {
    return nameServers_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public java.util.List<? extends cloud.paolu.xray.common.net.EndpointOrBuilder> 
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public cloud.paolu.xray.common.net.Endpoint getNameServers(int index) {
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public cloud.paolu.xray.common.net.EndpointOrBuilder getNameServersOrBuilder(
      int index) {
    return nameServers_.get(index);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<cloud.paolu.xray.app.dns.NameServer> nameServer_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<cloud.paolu.xray.app.dns.NameServer> getNameServerList() {
    return nameServer_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends cloud.paolu.xray.app.dns.NameServerOrBuilder> 
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.dns.NameServer getNameServer(int index) {
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.dns.NameServerOrBuilder getNameServerOrBuilder(
      int index) {
    return nameServer_.get(index);
  }
  ...
  private static final class HostsDefaultEntryHolder {
    static final com.google.protobuf.MapEntry<
        java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> defaultEntry =
            com.google.protobuf.MapEntry
            .<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain>newDefaultInstance(
                cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_HostsEntry_descriptor, 
                com.google.protobuf.WireFormat.FieldType.STRING,
                "",
                com.google.protobuf.WireFormat.FieldType.MESSAGE,
                cloud.paolu.xray.common.net.IPOrDomain.getDefaultInstance());
  }
  @SuppressWarnings("serial")
  private com.google.protobuf.MapField<
      java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> hosts_;
  private com.google.protobuf.MapField<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain>
  internalGetHosts() {
    if (hosts_ == null) {
  ...
  public java.util.Map<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> getHosts() {
    return getHostsMap();
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public java.util.Map<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> getHostsMap() {
...
cloud.paolu.xray.common.net.IPOrDomain defaultValue) {
    if (key == null) { throw new NullPointerException("map key"); }
    java.util.Map<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> map =
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public cloud.paolu.xray.common.net.IPOrDomain getHostsOrThrow(
      java.lang.String key) {
    if (key == null) { throw new NullPointerException("map key"); }
    java.util.Map<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> map =
        internalGetHosts().getMap();
  ...
  @SuppressWarnings("serial")
  private java.util.List<cloud.paolu.xray.app.dns.Config.HostMapping> staticHosts_;
  /**
   * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
   */
  @java.lang.Override
  public java.util.List<cloud.paolu.xray.app.dns.Config.HostMapping> getStaticHostsList() {
    return staticHosts_;
  }
  /**
   * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
   */
  @java.lang.Override
  public java.util.List<? extends cloud.paolu.xray.app.dns.Config.HostMappingOrBuilder> 
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.dns.Config.HostMapping getStaticHosts(int index) {
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.dns.Config.HostMappingOrBuilder getStaticHostsOrBuilder(
      int index) {
    return staticHosts_.get(index);
  }
   ...
   */
  @java.lang.Override public cloud.paolu.xray.app.dns.QueryStrategy getQueryStrategy() {
    cloud.paolu.xray.app.dns.QueryStrategy result = cloud.paolu.xray.app.dns.QueryStrategy.forNumber(queryStrategy_);
    return result == null ? cloud.paolu.xray.app.dns.QueryStrategy.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (queryStrategy_ != cloud.paolu.xray.app.dns.QueryStrategy.USE_IP.getNumber()) {
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> entry
         : internalGetHosts().getMap().entrySet()) {
      com.google.protobuf.MapEntry<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain>
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cloud.paolu.xray.app.dns.Config)) {
      return super.equals(obj);
    }
    cloud.paolu.xray.app.dns.Config other = (cloud.paolu.xray.app.dns.Config) obj;
  ...
  public static cloud.paolu.xray.app.dns.Config parseFrom(
      java.nio.ByteBuffer data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static cloud.paolu.xray.app.dns.Config parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cloud.paolu.xray.app.dns.Config parseFrom(
  ...
  public static cloud.paolu.xray.app.dns.Config parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseWithIOException(PARSER, input);
  }
  ...
  public static cloud.paolu.xray.app.dns.Config parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static cloud.paolu.xray.app.dns.Config parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cloud.paolu.xray.app.dns.Config prototype) {
    return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
  }
  @java.lang.Override
  public Builder toBuilder() {
  ...
  public static final class Builder extends
      ...
      cloud.paolu.xray.app.dns.ConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cloud.paolu.xray.app.dns.ConfigOuterClass.internal_static_xray_app_dns_Config_descriptor;
    }
    ...
    // Construct using cloud.paolu.xray.app.dns.Config.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public cloud.paolu.xray.app.dns.Config getDefaultInstanceForType() {
      return cloud.paolu.xray.app.dns.Config.getDefaultInstance();
    }

    @java.lang.Override
    public cloud.paolu.xray.app.dns.Config build() {
      cloud.paolu.xray.app.dns.Config result = buildPartial();
      if (!result.isInitialized()) {
        throw newUninitializedMessageException(result);
      }
      return result;
    ...
    @java.lang.Override
    public cloud.paolu.xray.app.dns.Config buildPartial() {
      cloud.paolu.xray.app.dns.Config result = new cloud.paolu.xray.app.dns.Config(this);
      buildPartialRepeatedFields(result);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    ...
    private void buildPartialRepeatedFields(cloud.paolu.xray.app.dns.Config result) {
      if (nameServersBuilder_ == null) {
    ...
    private void buildPartial0(cloud.paolu.xray.app.dns.Config result) {
      int from_bitField0_ = bitField0_;
    ...
    @java.lang.Override
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cloud.paolu.xray.app.dns.Config) {
        return mergeFrom((cloud.paolu.xray.app.dns.Config)other);
      } else {
        super.mergeFrom(other);
        return this;
      }
    ...
    public Builder mergeFrom(cloud.paolu.xray.app.dns.Config other) {
      if (other == cloud.paolu.xray.app.dns.Config.getDefaultInstance()) return this;
      if (nameServersBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              cloud.paolu.xray.common.net.Endpoint m =
                  input.readMessage(
                      cloud.paolu.xray.common.net.Endpoint.parser(),
                      extensionRegistry);
              if (nameServersBuilder_ == null) {
                ensureNameServersIsMutable();
                nameServers_.add(m);
            ...
            case 34: {
              cloud.paolu.xray.app.dns.Config.HostMapping m =
                  input.readMessage(
                      cloud.paolu.xray.app.dns.Config.HostMapping.parser(),
                      extensionRegistry);
              if (staticHostsBuilder_ == null) {
                ensureStaticHostsIsMutable();
                staticHosts_.add(m);
            ...
            case 42: {
              cloud.paolu.xray.app.dns.NameServer m =
                  input.readMessage(
                      cloud.paolu.xray.app.dns.NameServer.parser(),
                      extensionRegistry);
              if (nameServerBuilder_ == null) {
                ensureNameServerIsMutable();
                nameServer_.add(m);
    ...
    private void ensureNameServersIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        nameServers_ = new java.util.ArrayList<cloud.paolu.xray.common.net.Endpoint>(nameServers_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.common.net.Endpoint, cloud.paolu.xray.common.net.Endpoint.Builder, cloud.paolu.xray.common.net.EndpointOrBuilder> nameServersBuilder_;
    ...
    @java.lang.Deprecated public Builder setNameServers(
        int index, cloud.paolu.xray.common.net.Endpoint value) {
      if (nameServersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    @java.lang.Deprecated public Builder setNameServers(
        int index, cloud.paolu.xray.common.net.Endpoint.Builder builderForValue) {
      if (nameServersBuilder_ == null) {
        ensureNameServersIsMutable();
     ...
     * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
     */
    @java.lang.Deprecated public Builder addNameServers(cloud.paolu.xray.common.net.Endpoint value) {
      if (nameServersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    @java.lang.Deprecated public Builder addAllNameServers(
        java.lang.Iterable<? extends cloud.paolu.xray.common.net.Endpoint> values) {
      if (nameServersBuilder_ == null) {
        ensureNameServersIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, nameServers_);
     ...
     * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
     */
    @java.lang.Deprecated public cloud.paolu.xray.common.net.Endpoint.Builder getNameServersBuilder(
        int index) {
     ...
     * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
     */
    @java.lang.Deprecated public cloud.paolu.xray.common.net.Endpoint.Builder addNameServersBuilder() {
      return getNameServersFieldBuilder().addBuilder(
          cloud.paolu.xray.common.net.Endpoint.getDefaultInstance());
    }
    /**
     * <pre>
     * Nameservers used by this DNS. Only traditional UDP servers are support at
    ...
    @java.lang.Deprecated public cloud.paolu.xray.common.net.Endpoint.Builder addNameServersBuilder(
        int index) {
      return getNameServersFieldBuilder().addBuilder(
          index, cloud.paolu.xray.common.net.Endpoint.getDefaultInstance());
    }
    /**
     * <pre>
     * Nameservers used by this DNS. Only traditional UDP servers are support at
     ...
     * <code>repeated .xray.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
     */
    @java.lang.Deprecated public java.util.List<cloud.paolu.xray.common.net.Endpoint.Builder> 
    ...
    private void ensureNameServerIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        nameServer_ = new java.util.ArrayList<cloud.paolu.xray.app.dns.NameServer>(nameServer_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.dns.NameServer, cloud.paolu.xray.app.dns.NameServer.Builder, cloud.paolu.xray.app.dns.NameServerOrBuilder> nameServerBuilder_;
    ...
    public Builder setNameServer(
        int index, cloud.paolu.xray.app.dns.NameServer value) {
      if (nameServerBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setNameServer(
        int index, cloud.paolu.xray.app.dns.NameServer.Builder builderForValue) {
      if (nameServerBuilder_ == null) {
        ensureNameServerIsMutable();
     ...
     * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
     */
    public Builder addNameServer(cloud.paolu.xray.app.dns.NameServer value) {
      if (nameServerBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addNameServer(
        cloud.paolu.xray.app.dns.NameServer.Builder builderForValue) {
      if (nameServerBuilder_ == null) {
        ensureNameServerIsMutable();
    ...
    public Builder addAllNameServer(
        java.lang.Iterable<? extends cloud.paolu.xray.app.dns.NameServer> values) {
      if (nameServerBuilder_ == null) {
        ensureNameServerIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, nameServer_);
     ...
     * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
     */
    public cloud.paolu.xray.app.dns.NameServer.Builder getNameServerBuilder(
        int index) {
     ...
     * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
     */
    public cloud.paolu.xray.app.dns.NameServer.Builder addNameServerBuilder() {
      return getNameServerFieldBuilder().addBuilder(
          cloud.paolu.xray.app.dns.NameServer.getDefaultInstance());
    }
    /**
     * <pre>
     * NameServer list used by this DNS client.
    ...
    public cloud.paolu.xray.app.dns.NameServer.Builder addNameServerBuilder(
        int index) {
      return getNameServerFieldBuilder().addBuilder(
          index, cloud.paolu.xray.app.dns.NameServer.getDefaultInstance());
    }
    /**
     * <pre>
     * NameServer list used by this DNS client.
     ...
     * <code>repeated .xray.app.dns.NameServer name_server = 5;</code>
     */
    public java.util.List<cloud.paolu.xray.app.dns.NameServer.Builder> 
         getNameServerBuilderList() {
      return getNameServerFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.dns.NameServer, cloud.paolu.xray.app.dns.NameServer.Builder, cloud.paolu.xray.app.dns.NameServerOrBuilder> 
    ...
    private com.google.protobuf.MapField<
        java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> hosts_;
    @java.lang.Deprecated private com.google.protobuf.MapField<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain>
        internalGetHosts() {
      if (hosts_ == null) {
        return com.google.protobuf.MapField.emptyMapField(
            HostsDefaultEntryHolder.defaultEntry);
...
cloud.paolu.xray.common.net.IPOrDomain defaultValue) {
     ...
     */
    @java.lang.Deprecated
    public java.util.Map<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain>
        getMutableHosts() {
      bitField0_ |= 0x00000004;
    ...
    @java.lang.Deprecated public Builder putHosts(
        java.lang.String key,
        cloud.paolu.xray.common.net.IPOrDomain value) {
      if (key == null) { throw new NullPointerException("map key"); }
    ...
    @java.lang.Deprecated public Builder putAllHosts(
        java.util.Map<java.lang.String, cloud.paolu.xray.common.net.IPOrDomain> values) {
      internalGetMutableHosts().getMutableMap()
          .putAll(values);
      bitField0_ |= 0x00000004;
      return this;
    ...
    private void ensureStaticHostsIsMutable() {
      if (!((bitField0_ & 0x00000010) != 0)) {
        staticHosts_ = new java.util.ArrayList<cloud.paolu.xray.app.dns.Config.HostMapping>(staticHosts_);
        bitField0_ |= 0x00000010;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.dns.Config.HostMapping, cloud.paolu.xray.app.dns.Config.HostMapping.Builder, cloud.paolu.xray.app.dns.Config.HostMappingOrBuilder> staticHostsBuilder_;
    ...
    public Builder setStaticHosts(
        int index, cloud.paolu.xray.app.dns.Config.HostMapping value) {
      if (staticHostsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setStaticHosts(
        int index, cloud.paolu.xray.app.dns.Config.HostMapping.Builder builderForValue) {
      if (staticHostsBuilder_ == null) {
        ensureStaticHostsIsMutable();
     ...
     * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
     */
    public Builder addStaticHosts(cloud.paolu.xray.app.dns.Config.HostMapping value) {
      if (staticHostsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addStaticHosts(
        cloud.paolu.xray.app.dns.Config.HostMapping.Builder builderForValue) {
      if (staticHostsBuilder_ == null) {
        ensureStaticHostsIsMutable();
    ...
    public Builder addAllStaticHosts(
        java.lang.Iterable<? extends cloud.paolu.xray.app.dns.Config.HostMapping> values) {
      if (staticHostsBuilder_ == null) {
        ensureStaticHostsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, staticHosts_);
     ...
     * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
     */
    public cloud.paolu.xray.app.dns.Config.HostMapping.Builder getStaticHostsBuilder(
        int index) {
     ...
     * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
     */
    public cloud.paolu.xray.app.dns.Config.HostMapping.Builder addStaticHostsBuilder() {
      return getStaticHostsFieldBuilder().addBuilder(
          cloud.paolu.xray.app.dns.Config.HostMapping.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
     */
    public cloud.paolu.xray.app.dns.Config.HostMapping.Builder addStaticHostsBuilder(
        int index) {
      return getStaticHostsFieldBuilder().addBuilder(
          index, cloud.paolu.xray.app.dns.Config.HostMapping.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.dns.Config.HostMapping static_hosts = 4;</code>
     */
    public java.util.List<cloud.paolu.xray.app.dns.Config.HostMapping.Builder> 
         getStaticHostsBuilderList() {
      return getStaticHostsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.dns.Config.HostMapping, cloud.paolu.xray.app.dns.Config.HostMapping.Builder, cloud.paolu.xray.app.dns.Config.HostMappingOrBuilder> 
     ...
     */
    @java.lang.Override
    public cloud.paolu.xray.app.dns.QueryStrategy getQueryStrategy() {
      cloud.paolu.xray.app.dns.QueryStrategy result = cloud.paolu.xray.app.dns.QueryStrategy.forNumber(queryStrategy_);
      return result == null ? cloud.paolu.xray.app.dns.QueryStrategy.UNRECOGNIZED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setQueryStrategy(cloud.paolu.xray.app.dns.QueryStrategy value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000080;
  ...
  private static final cloud.paolu.xray.app.dns.Config DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cloud.paolu.xray.app.dns.Config();
  }

  public static cloud.paolu.xray.app.dns.Config getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
