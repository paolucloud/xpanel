...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cloud.paolu.xray.app.router.ConfigOuterClass.internal_static_xray_app_router_Config_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return cloud.paolu.xray.app.router.ConfigOuterClass.internal_static_xray_app_router_Config_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cloud.paolu.xray.app.router.Config.class, cloud.paolu.xray.app.router.Config.Builder.class);
  }
  ...
  public enum DomainStrategy
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return cloud.paolu.xray.app.router.Config.getDescriptor().getEnumTypes().get(0);
    }
   ...
   */
  @java.lang.Override public cloud.paolu.xray.app.router.Config.DomainStrategy getDomainStrategy() {
    cloud.paolu.xray.app.router.Config.DomainStrategy result = cloud.paolu.xray.app.router.Config.DomainStrategy.forNumber(domainStrategy_);
    return result == null ? cloud.paolu.xray.app.router.Config.DomainStrategy.UNRECOGNIZED : result;
  }

  public static final int RULE_FIELD_NUMBER = 2;
  @SuppressWarnings("serial")
  private java.util.List<cloud.paolu.xray.app.router.RoutingRule> rule_;
  /**
   * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
   */
  @java.lang.Override
  public java.util.List<cloud.paolu.xray.app.router.RoutingRule> getRuleList() {
    return rule_;
  }
  /**
   * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
   */
  @java.lang.Override
  public java.util.List<? extends cloud.paolu.xray.app.router.RoutingRuleOrBuilder> 
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.router.RoutingRule getRule(int index) {
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.router.RoutingRuleOrBuilder getRuleOrBuilder(
      int index) {
    return rule_.get(index);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<cloud.paolu.xray.app.router.BalancingRule> balancingRule_;
  /**
   * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
   */
  @java.lang.Override
  public java.util.List<cloud.paolu.xray.app.router.BalancingRule> getBalancingRuleList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends cloud.paolu.xray.app.router.BalancingRuleOrBuilder> 
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.router.BalancingRule getBalancingRule(int index) {
   ...
   */
  @java.lang.Override
  public cloud.paolu.xray.app.router.BalancingRuleOrBuilder getBalancingRuleOrBuilder(
      int index) {
    return balancingRule_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (domainStrategy_ != cloud.paolu.xray.app.router.Config.DomainStrategy.AsIs.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cloud.paolu.xray.app.router.Config)) {
      return super.equals(obj);
    }
    cloud.paolu.xray.app.router.Config other = (cloud.paolu.xray.app.router.Config) obj;
  ...
  public static cloud.paolu.xray.app.router.Config parseFrom(
  ...
  public static cloud.paolu.xray.app.router.Config parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cloud.paolu.xray.app.router.Config parseFrom(
  ...
  public static cloud.paolu.xray.app.router.Config parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cloud.paolu.xray.app.router.Config parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static cloud.paolu.xray.app.router.Config parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cloud.paolu.xray.app.router.Config prototype) {
  ...
  public static final class Builder extends
      ...
      cloud.paolu.xray.app.router.ConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cloud.paolu.xray.app.router.ConfigOuterClass.internal_static_xray_app_router_Config_descriptor;
    }
    ...
    // Construct using cloud.paolu.xray.app.router.Config.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public cloud.paolu.xray.app.router.Config getDefaultInstanceForType() {
      return cloud.paolu.xray.app.router.Config.getDefaultInstance();
    }

    @java.lang.Override
    public cloud.paolu.xray.app.router.Config build() {
      cloud.paolu.xray.app.router.Config result = buildPartial();
    ...
    @java.lang.Override
    public cloud.paolu.xray.app.router.Config buildPartial() {
      cloud.paolu.xray.app.router.Config result = new cloud.paolu.xray.app.router.Config(this);
    ...
    private void buildPartialRepeatedFields(cloud.paolu.xray.app.router.Config result) {
      if (ruleBuilder_ == null) {
    ...
    private void buildPartial0(cloud.paolu.xray.app.router.Config result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cloud.paolu.xray.app.router.Config) {
        return mergeFrom((cloud.paolu.xray.app.router.Config)other);
      } else {
    ...
    public Builder mergeFrom(cloud.paolu.xray.app.router.Config other) {
      if (other == cloud.paolu.xray.app.router.Config.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              cloud.paolu.xray.app.router.RoutingRule m =
                  input.readMessage(
                      cloud.paolu.xray.app.router.RoutingRule.parser(),
                      extensionRegistry);
              if (ruleBuilder_ == null) {
                ensureRuleIsMutable();
                rule_.add(m);
            ...
            case 26: {
              cloud.paolu.xray.app.router.BalancingRule m =
                  input.readMessage(
                      cloud.paolu.xray.app.router.BalancingRule.parser(),
                      extensionRegistry);
              if (balancingRuleBuilder_ == null) {
                ensureBalancingRuleIsMutable();
     ...
     */
    @java.lang.Override
    public cloud.paolu.xray.app.router.Config.DomainStrategy getDomainStrategy() {
      cloud.paolu.xray.app.router.Config.DomainStrategy result = cloud.paolu.xray.app.router.Config.DomainStrategy.forNumber(domainStrategy_);
      return result == null ? cloud.paolu.xray.app.router.Config.DomainStrategy.UNRECOGNIZED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setDomainStrategy(cloud.paolu.xray.app.router.Config.DomainStrategy value) {
      if (value == null) {
    ...
    private void ensureRuleIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        rule_ = new java.util.ArrayList<cloud.paolu.xray.app.router.RoutingRule>(rule_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.router.RoutingRule, cloud.paolu.xray.app.router.RoutingRule.Builder, cloud.paolu.xray.app.router.RoutingRuleOrBuilder> ruleBuilder_;
    ...
    public Builder setRule(
        int index, cloud.paolu.xray.app.router.RoutingRule value) {
      if (ruleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setRule(
        int index, cloud.paolu.xray.app.router.RoutingRule.Builder builderForValue) {
      if (ruleBuilder_ == null) {
        ensureRuleIsMutable();
     ...
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public Builder addRule(cloud.paolu.xray.app.router.RoutingRule value) {
      if (ruleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addRule(
        cloud.paolu.xray.app.router.RoutingRule.Builder builderForValue) {
      if (ruleBuilder_ == null) {
        ensureRuleIsMutable();
    ...
    public Builder addAllRule(
        java.lang.Iterable<? extends cloud.paolu.xray.app.router.RoutingRule> values) {
      if (ruleBuilder_ == null) {
        ensureRuleIsMutable();
     ...
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public cloud.paolu.xray.app.router.RoutingRule.Builder getRuleBuilder(
        int index) {
     ...
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public cloud.paolu.xray.app.router.RoutingRule.Builder addRuleBuilder() {
      return getRuleFieldBuilder().addBuilder(
          cloud.paolu.xray.app.router.RoutingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public cloud.paolu.xray.app.router.RoutingRule.Builder addRuleBuilder(
        int index) {
      return getRuleFieldBuilder().addBuilder(
          index, cloud.paolu.xray.app.router.RoutingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.RoutingRule rule = 2;</code>
     */
    public java.util.List<cloud.paolu.xray.app.router.RoutingRule.Builder> 
         getRuleBuilderList() {
      return getRuleFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.router.RoutingRule, cloud.paolu.xray.app.router.RoutingRule.Builder, cloud.paolu.xray.app.router.RoutingRuleOrBuilder> 
        getRuleFieldBuilder() {
      if (ruleBuilder_ == null) {
    ...
    private void ensureBalancingRuleIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        balancingRule_ = new java.util.ArrayList<cloud.paolu.xray.app.router.BalancingRule>(balancingRule_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.router.BalancingRule, cloud.paolu.xray.app.router.BalancingRule.Builder, cloud.paolu.xray.app.router.BalancingRuleOrBuilder> balancingRuleBuilder_;
    ...
    public Builder setBalancingRule(
        int index, cloud.paolu.xray.app.router.BalancingRule value) {
      if (balancingRuleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setBalancingRule(
        int index, cloud.paolu.xray.app.router.BalancingRule.Builder builderForValue) {
      if (balancingRuleBuilder_ == null) {
        ensureBalancingRuleIsMutable();
     ...
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public Builder addBalancingRule(cloud.paolu.xray.app.router.BalancingRule value) {
      if (balancingRuleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addBalancingRule(
        cloud.paolu.xray.app.router.BalancingRule.Builder builderForValue) {
      if (balancingRuleBuilder_ == null) {
        ensureBalancingRuleIsMutable();
    ...
    public Builder addAllBalancingRule(
        java.lang.Iterable<? extends cloud.paolu.xray.app.router.BalancingRule> values) {
      if (balancingRuleBuilder_ == null) {
        ensureBalancingRuleIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public cloud.paolu.xray.app.router.BalancingRule.Builder getBalancingRuleBuilder(
        int index) {
     ...
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public cloud.paolu.xray.app.router.BalancingRule.Builder addBalancingRuleBuilder() {
      return getBalancingRuleFieldBuilder().addBuilder(
          cloud.paolu.xray.app.router.BalancingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public cloud.paolu.xray.app.router.BalancingRule.Builder addBalancingRuleBuilder(
        int index) {
      return getBalancingRuleFieldBuilder().addBuilder(
          index, cloud.paolu.xray.app.router.BalancingRule.getDefaultInstance());
    }
    /**
     * <code>repeated .xray.app.router.BalancingRule balancing_rule = 3;</code>
     */
    public java.util.List<cloud.paolu.xray.app.router.BalancingRule.Builder> 
         getBalancingRuleBuilderList() {
      return getBalancingRuleFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cloud.paolu.xray.app.router.BalancingRule, cloud.paolu.xray.app.router.BalancingRule.Builder, cloud.paolu.xray.app.router.BalancingRuleOrBuilder> 
  ...
  private static final cloud.paolu.xray.app.router.Config DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cloud.paolu.xray.app.router.Config();
  }

  public static cloud.paolu.xray.app.router.Config getDefaultInstance() {
