...
public interface StreamConfigOrBuilder extends
   ...
   * <code>repeated .xray.common.serial.TypedMessage security_settings = 4;</code>
   */
  cloud.paolu.xray.common.serial.TypedMessage getSecuritySettings(int index);
  /**
   * <pre>
   * Settings for transport security. For now the only choice is TLS.
   * </pre>
   ...
   * <code>repeated .xray.common.serial.TypedMessage security_settings = 4;</code>
   */
  cloud.paolu.xray.common.serial.TypedMessageOrBuilder getSecuritySettingsOrBuilder(
      int index);
   ...
   */
  cloud.paolu.xray.transport.internet.SocketConfig getSocketSettings();
  /**
   * <code>.xray.transport.internet.SocketConfig socket_settings = 6;</code>
   */
  cloud.paolu.xray.transport.internet.SocketConfigOrBuilder getSocketSettingsOrBuilder();
}
